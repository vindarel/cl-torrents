...
not trivial at  first to start a  Lisp project, so this  tutorial is a
mix of hopefully useful stuff.
...
and beginner-friendly stuff and tips like this.

In part 2, "*Tests  and CI*", we write our first  unit test, with mocks,
which gives  us the opportunity to  write a first macro,  and we setup
Continuous Integration on Gitlab CI.

Part 3 is about  *building and delivering self-contained executables*,
...
Part 4, "Moving functions into  their own package", shows and explains
...
Part 5  is about  *error handling* or  rather condition  handling.

Part  6, "More  features", is  supposed to  be a  pot-pourri of  other
things but it shows only a cache system at the moment.
