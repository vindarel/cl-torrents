...
We'll carry on by writing  tests, running them automatically thanks to
a  Continuous Integration  system, then  we'll build  a self-contained
executable, using the advantages of  a couple Lisp implementations and
...
#+END_SRC
    ...
    Quick and easy, tell me if I missed something !
