...
#+END_SRC
   ...
   We  define a  dumb main  function.  It doesn't  parse command  line
   arguments yet:
...
#+END_SRC
   ...
   A caveat  is that we  must run this  function in another  REPL than
   Slime.
...
#+END_SRC
  ...
  is colorized but  the seeders and leechers are not  aligned any more
