...
Finally, Continuous Integration is well explained here:
...
- some *cache*
- *continuous integration* (see the Cookbook),
...
advantages of  a couple Lisp  implementations, and in the  doing we'll
